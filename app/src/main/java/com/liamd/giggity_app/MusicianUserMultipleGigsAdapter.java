...
/**
 * Created by liamd on 22/04/2017.
 */

public class MusicianUserMultipleGigsAdapter extends ArrayAdapter<Gig>
{
    ...
    public MusicianUserMultipleGigsAdapter(Context context, int resource, List<Gig> items)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        mVenueNameTextView = (TextView) gigsListView.findViewById(R.id.venueNameTextView);
        mDistanceTextView = (TextView) gigsListView.findViewById(R.id.gigDistanceTextView);
        ...
        mGigEndDateTextView = (TextView) gigsListView.findViewById(R.id.gigFinishDateTextView);

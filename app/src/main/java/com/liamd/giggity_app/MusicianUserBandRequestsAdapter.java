...
public class MusicianUserBandRequestsAdapter extends ArrayAdapter<BandRequest>
{
    ...
    public MusicianUserBandRequestsAdapter(Context context, int resource, List<BandRequest> items)
    {
